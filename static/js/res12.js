...
function downloadResume() {
    ...
    document.getElementById('resume-template').style.fontSize = '10px'; // Smaller font size
    ...
    const opt = {
      ...
      html2canvas: { scale: 2, useCORS: true }, // Adjust scale (smaller scale = smaller content)
