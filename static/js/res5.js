...
function downloadResume() {
    ...
    document.getElementById('cv-template').style.padding = '10px'; // Reduce padding
    document.getElementById('cv-template').style.margin = '0'; // Reduce margins
    document.getElementById('cv-template').style.fontSize = '14px'; // Smaller font size
